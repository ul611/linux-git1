...
_Некоторые особенности написания кода и запуска популярных юнит-тестов проектов Libft, Get Next Line, Ft_printf, Libft, Libft, Get Next Line, Ft_printf, Libft, Get Next Line, Ft_printf на Linux._
